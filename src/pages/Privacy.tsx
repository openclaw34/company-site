          ...
          <div className="prose-custom space-y-10">
            <section>
              ...
              <p className="text-gray-600 leading-relaxed">
                KANPAI ("we," "our," or "us") is committed to protecting the
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-2 text-gray-600">
                <li>
                  ...
                  and other contact details you provide when making inquiries
                  or bookings.
                </li>
                <li>
                  <strong>Usage Data:</strong> Information about how you access
                  and use our website, including IP address, browser type,
                  pages visited, and referring URLs.
                </li>
                <li>
                  <strong>Photos:</strong> Photographs taken during the tour
                  that may include your likeness.
                </li>
              </ul>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-2 text-gray-600 mt-3">
                <li>
                  ...
                  who assist in operating our services (e.g., payment
                  processing, email delivery), subject to confidentiality
                  agreements.
                </li>
                <li>
